...
function getReactNodeRef(element) {
  if (!element || !React26.isValidElement(element)) {
    return null;
  }
...
var useRtl = () => {
  const value = React30.useContext(RtlContext);
  return value ?? false;
};
...
function useCurrentColorScheme(options) {
  ...
  const [, setHasMounted] = React34.useState(false);
  ...
  const setMode = React34.useCallback((mode2) => {
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme2 = () => React35.useContext(ColorSchemeContext) || defaultContext;
  function CssVarsProvider2(props) {
    ...
    const element = (0, import_jsx_runtime11.jsxs)(React35.Fragment, {
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React54.useContext(SeriesContext);
  if (!isInitialized) {
...
function useBarSeries() {
  ...
  return React54.useMemo(() => series.bar, [series.bar]);
}

// node_modules/@mui/x-charts/context/CartesianProvider/CartesianContext.js
var React55 = __toESM(require_react());
var CartesianContext = React55.createContext({
  isInitialized: false,
  data: {
    xAxis: {},
    yAxis: {},
...
function CartesianProvider(props) {
  ...
  const xValues = React56.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React56.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
var useCartesianContext = () => {
  const {
    data
  } = React57.useContext(CartesianContext);
  return data;
};
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React60.useLayoutEffect : React60.useEffect;
...
function ChartsText(props) {
  ...
  const wordsByLines = React68.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime22.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index2) => (0, import_jsx_runtime22.jsx)("tspan", {
      x: x2,
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime23.jsxs)(XAxisRoot, {
    transform: `translate(0, ${position3 === "bottom" ? top2 + height2 : top2})`,
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime24.jsxs)(YAxisRoot, {
    transform: `translate(${position3 === "right" ? left2 + width2 : left2}, 0)`,
    className: classes.root,
    sx,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime25.jsxs)(React72.Fragment, {
...
@mui/system/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SV4F6B2C.js.map
