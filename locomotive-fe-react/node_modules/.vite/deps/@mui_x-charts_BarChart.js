...
import {
  ...
  useSlotProps_default2,
  useTheme,
  useThemeProps,
  useTicks
} from "./chunk-SV4F6B2C.js";
import {
  require_jsx_runtime
  ...
  return {
    ...
    flush(arg2) {
      if (current.size) {
        ...
        eachSafely(current, (fn2) => fn2(arg2) && next.add(fn2));
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(Bar, _extends({}, barProps));
}
...
function useChartId() {
  ...
  return React10.useMemo(() => chartId, [chartId]);
}
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime5.jsx)(animated.rect, {
...
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime5.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime5.jsx)(BarClipRect, {
      ownerState: rest,
      style
    })
  });
...
function BarLabel(inProps) {
  ...
  return (0, import_jsx_runtime6.jsx)(BarLabelComponent, _extends({}, otherProps));
}
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(React16.Fragment, {
    children: barLabelTransition((style, {
      ...
      width,
      height
    }) => (0, import_jsx_runtime8.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color: color2,
...
function useChartGradient() {
  ...
  return React23.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React24.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React24.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var ChartContainer = React26.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
            ...
            children: (0, import_jsx_runtime14.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime14.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime14.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime14.jsx)(ChartsAxesGradients, {}), children]
                }))
              }))
            })
          }))
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  ...
  const computeSize = React27.useCallback(() => {
...
var _excluded10 = ["width", "height", "resolveSizeBeforeRender", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis"];
...
var ResponsiveChartContainer = React28.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
var Popper3 = React34.forwardRef(function Popper4(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(PopperRoot, {
    as: component,
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types16.default.func.isRequired,
  /**
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types18.default.object.isRequired,
  /**
...
var legendClasses = generateUtilityClasses2("MuiChartsLegend", ["root", "series", "itemBackground", "mark", "label", "column", "row"]);
...
var _excluded13 = ["drawingArea", "seriesToDisplay", "hidden", "onItemClick"];
...
true ? DefaultChartsLegend.propTypes = {
  ...
  seriesToDisplay: import_prop_types20.default.arrayOf(import_prop_types20.default.shape({
    ...
    itemId: import_prop_types20.default.oneOfType([import_prop_types20.default.number, import_prop_types20.default.string]),
    label: import_prop_types20.default.string.isRequired,
    maxValue: import_prop_types20.default.oneOfType([import_prop_types20.default.instanceOf(Date), import_prop_types20.default.number]),
    minValue: import_prop_types20.default.oneOfType([import_prop_types20.default.instanceOf(Date), import_prop_types20.default.number]),
...
function ChartsLegend(inProps) {
  ...
  const {
    slots,
    slotProps
  } = defaultizedProps, other = _objectWithoutPropertiesLoose(defaultizedProps, _excluded14);
  const theme = useTheme();
  ...
  const chartLegendRenderProps = useSlotProps_default2({
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime33.jsxs)(React50.Fragment, {
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types22.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types22.default.oneOfType([import_prop_types22.default.number, import_prop_types22.default.string]),
  /**
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types22.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types22.default.number,
  /**
...
var _excluded15 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter", "onItemClick"];
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types23.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types23.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types23.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime38.jsx)(React55.Fragment, {
    children: yTicks.map(({
      formattedValue,
      offset: offset2
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(React57.Fragment, {});
}
...
var _excluded19 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "axisHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "barLabel", "className"];
...
var BarChart = React61.forwardRef(function BarChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  });
...
true ? BarChart.propTypes = {
  ...
  legend: import_prop_types28.default.shape({
    ...
    itemGap: import_prop_types28.default.number,
    itemMarkHeight: import_prop_types28.default.number,
    itemMarkWidth: import_prop_types28.default.number,
    labelStyle: import_prop_types28.default.object,
    markGap: import_prop_types28.default.number,
    onItemClick: import_prop_types28.default.func,
    padding: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.shape({
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types28.default.bool,
  /**
